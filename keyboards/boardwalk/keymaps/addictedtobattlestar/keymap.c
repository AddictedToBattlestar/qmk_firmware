...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    LSFT(KC_F6), LALT(LGUI(KC_M)), KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT,  \
           KC_LGUI, KC_LALT, KC_LCTL, LOWER,       KC_BSPC,              KC_SPC,                KC_LEFT, KC_RGHT, KC_DOWN, KC_UP
  ),
  ...
  _______, _______, _______, _______, _______, _______, LSFT(LGUI(KC_LBRC)), LSFT(LGUI(KC_RBRC)), KC_LEFT, _______, KC_RGHT, _______, _______, _______, \
  _______, _______, _______, _______, _______, _______, _______,             _______,             _______, KC_DOWN, _______, _______, _______, _______, \
