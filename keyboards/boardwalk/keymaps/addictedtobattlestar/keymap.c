...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_ortho_hhkb(
    RESET, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   _______,     A_RUN,      KC_F6,  KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  \
  _______, _______, _______, _______, _______, _______, RGB_SAI,     RGB_HUI,            _______,   KC_UP, _______, _______, _______, KC_F12,  \
  _______, _______, _______, _______, _______, _______, RGB_SAD,     RGB_HUD,            KC_LEFT, _______, KC_RGHT, _______, _______, _______, \
  KC_MUTE, _______, _______, _______, _______, _______, RGB_VAD,     RGB_VAI,            _______, KC_DOWN, _______, _______, _______, _______, \
           KC_VOLD, KC_VOLU, _______, _______,      KC_MPLY,                 A_RUN,               KC_HOME, KC_PGDN, KC_PGUP, KC_END
  )
};
