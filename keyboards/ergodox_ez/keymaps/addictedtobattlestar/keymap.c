 ...
 */
    ...
    [BASE] = LAYOUT_ergodox( // layer 0 : default
        ...
        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, LGUI(LSFT(KC_LBRC)),
        KC_LGUI, KC_LALT, KC_LCTRL, KC_HOME, KC_END,
        KC_LEFT, KC_RGHT,
        KC_UP,
 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |        |  F1  |  F2  |  F3  |  F4  |  F5  |      |           | LGui |  F6  |  F7  |  F8  |  F9  |  F10 |   F11  |
 *                                                                   Alt
 *                                                                    R
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |        |   !  |   @  |   {  |   }  |   |  |      |           |      |   Up |   7  |   8  |   9  |      |   F12  |
...
[SYMB] = LAYOUT_ergodox(
       ...
       // right hand
       LGUI(LALT(KC_R)), KC_F6,   KC_F7,  KC_F8,   KC_F9,   KC_F10,  KC_F11,
 ...
 * | LShift |   Z  |   X   |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  |   /  | RShift |
 * `--------+------+-------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | Ctrl | Alt  | LGui  | Home | End  |                                       |      |      | LGui | Alt  | Ctrl |
 *   `-----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | Left | Rght |       | SYMB | BASE |
 *                                 ,------|------|------|       |------+--------+------.
 ...
 */
    ...
    [PC] = LAYOUT_ergodox( // layer 0 : default
        ...
        KC_LCTRL, KC_LALT, KC_LGUI, KC_HOME, KC_END,
        KC_LEFT, KC_RGHT,
        KC_UP,
        KC_BSPC, KC_TAB, KC_DOWN,
        // right hand
        ...
        KC_NO, KC_NO, KC_RGUI, KC_RALT, KC_RCTRL,
        TO(SYMB), TO(BASE),
        KC_PGUP,
        KC_PGDN, KC_ENT, KC_SPC),
};
